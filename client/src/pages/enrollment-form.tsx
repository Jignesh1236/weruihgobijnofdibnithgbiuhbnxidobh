                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (studentName) {
                            // Extract father's name (last word only)
                            const nameParts = studentName.trim().split(/\s+/);
                            if (nameParts.length >= 2) {
                              const fatherName = nameParts[nameParts.length - 1]; // Last word is father's name
                              form.setValue("fatherName", fatherName.toUpperCase());
                            }
                          }
                        }}
                    ...
                    <FormControl>
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <option value="11th Pass">11th Pass</option>
                        ...
                        {(field.value === "" || !["8th Pass", "9th Pass", "10th Pass", "11th Pass", "12th Pass", "ITI", "Diploma", "B.A", "B.Com", "B.Sc", "B.Tech", "BCA", "BBA", "M.A", "M.Com", "M.Sc", "M.Tech", "MCA", "MBA"].includes(field.value)) && (
                          <Input 
                            placeholder="Enter custom education (e.g., B.Tech CSE, Diploma in Mechanical)"
                            value={field.value}
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          const studentName = form.getValues("studentName");
                          if (studentName) {
                            // Take only first two words (first name + middle name, exclude father's name)
                            const nameParts = studentName.trim().split(/\s+/);
                            const firstTwoNames = nameParts.slice(0, 2).join(' ');

                            // Remove spaces and convert to lowercase
                            const cleanName = firstTwoNames
                              .toLowerCase()
                              .replace(/\s+/g, '')
                              .replace(/[^a-z]/g, ''); // Remove non-alphabetic characters
                            const generatedEmail = `${cleanName}2025@gmail.com`;
                            form.setValue("studentEmail", generatedEmail);
                          }
                        }}
                        className="whitespace-nowrap"
                      >
