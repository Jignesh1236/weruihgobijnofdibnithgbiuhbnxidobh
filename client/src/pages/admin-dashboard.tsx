                          ...
                          {filteredInquiries?.slice(0, 5).map((inquiry) => (
                            ...
                            >
                              ...
                              <Badge 
                                ...
                                className={inquiry.status === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'}
                              >
                                {inquiry.status}
                              </Badge>
                            </motion.div>
                                  ...
                                  {inquiry.status === 'pending' && (
                                    <>
                                      <Button 
                                        ...
                                        onClick={() => setLocation(`/enrollment/new?inquiryId=${inquiry.id}`)}
                                      ...
                                      <Button 
                                        ...
                                        onClick={() => updateInquiryStatusMutation.mutate({ id: inquiry.id, status: "confirmed" })}
